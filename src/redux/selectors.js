...
export const cartedItemsSelector = createSelector(addedItemSelector, (addedItem) => {
...
export const selectItemTotal = (state) =>
  state.cartHandle.addedItem.reduce((accumulator, currentValue) => accumulator + currentValue.price, 0);
